...
/* edit.html.twig */
class __TwigTemplate_2faf555afe18e6eb71f85a8e12f9f01819e903aa8127a23503cdcbc1e9d0201a extends Twig_Template
{
...
/*         <li><a href="#tab-acesso" data-toggle="tab">{% trans %}Acesso{% endtrans %}</a></li>*/
/*     </ul>*/
/*     <div class="tab-content">*/
/*         <div id="tab-geral" class="tab-pane active">*/
/*             <div class="form-group required">*/
/*                 <label for="login">{% trans %}Nome de usuário{% endtrans %}</label>*/
...
/*             </div>*/
/*             <div class="form-group required">*/
/*                 <label for="descricao">{% trans %}Sobrenome{% endtrans %}</label>*/
...
/*                 </div>*/
/*                 <div class="form-group required">*/
/*                     <label for="confirmacao">{% trans %}Confirmar senha{% endtrans %}</label>*/
/*                     <input id="confirmacao" type="password" name="senha2" class="form-control" maxlength="40" />*/
/*                 </div>*/
/*             {% endif %}*/
/*         </div>*/
...
/*                 <div class="modal-header">*/
/*                     <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>*/
/*                     <h4 class="modal-title">{% trans %}Lotação{% endtrans %}</h4>*/
/*                 </div>*/
/*                 <div class="modal-body">*/
/*                     <div class="form-group">*/
...
/*                 </div>*/
/*                 <div class="modal-footer">*/
/*                     <button type="button" class="btn btn-primary" onclick="SGA.Usuarios.addLotacao()">{% trans %}Adicionar{% endtrans %}</button>*/
/*                 </div>*/
/*             </div>*/
/*         </div>*/
/*     </div>*/
...
/*                 <div class="modal-body">*/
/*                     <div class="form-group">*/
/*                         <label for="add-unidade">{% trans %}Unidade{% endtrans %}</label>*/
/*                         <select id="add-unidade"*/
/*                                 class="form-control"*/
/*                                 onchange="SGA.Usuarios.servicos_unidade($(this).val())">*/
/*                             <option value="">{% trans %}Selecione{% endtrans %}</option>*/
...
/*                 </div>*/
/*                 <div class="modal-footer">*/
/*                     <button type="button" class="btn btn-primary" onclick="SGA.Usuarios.addServico()">{% trans %}Adicionar{% endtrans %}</button>*/
/*                 </div>*/
/*             </div>*/
/*         </div>*/
/*     </div>*/
